...
import { categories } from "../addExpense/addExpensePage";
                  ...
                  <TableRow key={tx.id}>
                    ...
                    <TableCell className="text-right">
                      <div className="flex justify-end gap-3">
                        <Pencil className="h-6 w-6 cursor-pointer text-gray-600 hover:text-black" />
                        <Trash2 className="h-6 w-6 cursor-pointer text-red-500 hover:text-red-700" onClick={() => handledelete(tx.id!)} />
                      </div>
                    </TableCell>
